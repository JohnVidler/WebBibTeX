// Adapted from https://github.com/dangmai/escape-latex
...
function latex_escape(str) {
    ...
    escapeKeys.forEach(function (key, index) {
        ...
        if (pos !== -1) {
            result = latex_escape(str.slice(0, pos)) + escapes[escapeKeys[index]] + latex_escape(str.slice(pos + match.length));
            regExpFound = true;
        }
    });
